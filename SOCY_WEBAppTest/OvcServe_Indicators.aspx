<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OvcServe_Indicators.aspx.cs" Inherits="SOCY_WEBAppTest.OvcServe_Indicators" %>
            ...
            <div id="page-wrapper">
                <div class="graphs">
                    ...
                    <div class="panel-heading">
                            <h4 class="panel-title"><asp:Label ID="Label3" runat="server" Text="OVC SERVE"></asp:Label><asp:Label ID="lblperiod" runat="server" Text="(2018-04-01 to 2018-06-30)" ForeColor="#0066ff" ></asp:Label>   </h4>
                        </div>
                    <div class="col_1">
                        <%--Indicators--%>
                        <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
                            <div class="panel-body no-padding">
                                ...
                                <asp:GridView ID="gdvOVCServe" AutoGenerateColumns="False" class="table table-striped" runat="server" GridLines="None">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="OVC_SERVE_INDICATOR" HeaderText="OVC Service Indicator"
