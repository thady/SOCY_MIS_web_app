...
{
    public static class Result_Area_three_reports
    {
        #region DBConnection
        ...
        public static DataTable GetRsesultArea01Report(string dst_id, string cso_id, string report_type, DateTime? datefrom, DateTime? dateTo)
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("sp_SOCY_OVC_reports", conn))
                {
        ...
        public static DataTable GetOVCReferral_graph_data(string dst_id, string cso_id, string report_type, DateTime? datefrom, DateTime? dateTo)
        {
            DataTable dt = new DataTable();
            DataSet ds = new DataSet("ovc_referrals");
            SqlDataAdapter Adapt;
            try
            {
                using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["SOCY_LIVE"].ToString()))
