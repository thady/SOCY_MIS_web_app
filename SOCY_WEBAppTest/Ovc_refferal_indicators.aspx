<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ovc_refferal_indicators.aspx.cs" Inherits="SOCY_WEBAppTest.Ovc_refferal_indicators" %>
        ...
        <form id="frmMain" runat="server">
            ...
            <div id="page-wrapper">
                <div class="graphs">
                    ...
                    <div class="col_1">
                        <h4>OVC Refferal Service Completion Indicators</h4>
                    </div>
                    <div class="col_1">
                        <%--Indicators--%>
                        <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
                            <div class="panel-body no-padding">
                                ...
                                <asp:GridView ID="gdv_refferal" AutoGenerateColumns="False" class="table table-striped" runat="server" GridLines="None">

                                    <Columns>
                                        <asp:BoundField DataField="service_indicator" HeaderText="Refferal Service Name"
                                            SortExpression="service_indicator"></asp:BoundField>
                                        <asp:BoundField DataField="Total" HeaderText="Completed Referal:Total Beneficiaries"
                                            SortExpression="Total"></asp:BoundField>
                                        <asp:BoundField DataField="Male" HeaderText="Completed Referal:Male"
                                            SortExpression="Male"></asp:BoundField>
                                        <asp:BoundField DataField="Female" HeaderText="Completed Referal:Female"
                                            SortExpression="Female"></asp:BoundField>
                                    </Columns>
