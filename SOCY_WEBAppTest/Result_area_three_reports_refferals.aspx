<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result_area_three_reports_refferals.aspx.cs" Inherits="SOCY_WEBAppTest.Result_area_three_reports_refferals" %>
        ...
        <form id="frmMain" runat="server">
            ...
            <div id="page-wrapper">
                <div class="graphs">
                    ...
                    <div class="col_1">
                        <h4 style="margin-left: 100px">Result Area 3 Tracking Indicators:Referrals</h4>
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
                            <div class="panel-body no-padding" style="height: 600px">
                                <asp:Label ID="lblovc_served" runat="server" Text="Referrals Initiated" ForeColor="#ff3300"></asp:Label>
                                <asp:GridView ID="gdv_ovc_refferals_made" AutoGenerateColumns="False" class="table table-striped" runat="server" AllowPaging="true" OnPageIndexChanging="gdv_ovc_refferals_made_PageIndexChanging" PageSize="7" GridLines="None">
                                    <Columns>
                                        <asp:BoundField DataField="sct_name" HeaderText="Sub County"
                                            SortExpression="sct_name"></asp:BoundField>
                                        <asp:BoundField DataField="svr_name" HeaderText="Referral Type"
                                            SortExpression="svr_name"></asp:BoundField>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
                            <div class="panel-body no-padding" style="height: 600px">
                                <asp:Label ID="lblgraphHeader" runat="server" Text="Referrals completed" ForeColor="#ff3300"></asp:Label>
                                <asp:GridView ID="gdv_ovc_refferals_completed" AutoGenerateColumns="False" class="table table-striped" runat="server" AllowPaging="true" OnPageIndexChanging="gdv_ovc_refferals_completed_PageIndexChanging" PageSize="7" GridLines="None">
                                    <Columns>
                                        <asp:BoundField DataField="sct_name" HeaderText="Sub County"
                                            SortExpression="sct_name"></asp:BoundField>
                                        <asp:BoundField DataField="svr_name" HeaderText="Referral Type"
                ...
                <div class="col-sm-12" style="text-align: center">
                    ...
                    <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
                        <div class="panel-body no-padding" style="height: 600px">
                            ...
                            <asp:Chart ID="OVCReferralChart" runat="server" Height="500px" Width="800px" Visible="false">
                                <Titles>
                                    <asp:Title Font="Times New Roman, 12pt, style=Bold, Italic" Name="Title1"
                                        Text="District Referral Completion Rate:Visualized Dataset" ForeColor="#ff0066">
                                    </asp:Title>
                                </Titles>
                                <Legends>
