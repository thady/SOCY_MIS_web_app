<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dreams_dashboard_reports.aspx.cs" Inherits="SOCY_WEBAppTest.Dreams_dashboard_reports" %>
        ...
        <form id="frmMain" runat="server">
            ...
            <div id="page-wrapper">
                <div class="graphs">
                    ...
                    <div class="col_1">
                        <h4 style="margin-left: 100px">DREAMS</h4>
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
                            <div class="panel-body no-padding" style="height: 600px">
                                <asp:Label ID="lblovc_served" runat="server" Text="Number of girls enrolled for DREAMS" ForeColor="#ff3300"></asp:Label>
                                <asp:GridView ID="gdv_drm_girls" AutoGenerateColumns="False" class="table table-striped" runat="server" AllowPaging="true" PageSize="7" GridLines="None">
                                    <Columns>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
                            <div class="panel-body no-padding" style="height: 600px">
                                <asp:Label ID="lblgraphHeader" runat="server" Text="Number of girls completing 14 sessions" ForeColor="#ff3300"></asp:Label>
                                <asp:GridView ID="gdv_drm_all_sessions" AutoGenerateColumns="False" class="table table-striped" runat="server" AllowPaging="true" PageSize="7" GridLines="None">
                                    <Columns>
                                        <asp:BoundField DataField="sct_name" HeaderText="Sub County"
                                            SortExpression="sct_name"></asp:BoundField>
                                        <asp:BoundField DataField="Total" HeaderText="Total Number"
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
                            <div class="panel-body no-padding" style="height: 600px">
                                <asp:Label ID="Label1" runat="server" Text="Total Groups receiving SINOVUYO trainings" ForeColor="#ff3300"></asp:Label>
                                <asp:GridView ID="gdv_drm_groups" AutoGenerateColumns="False" class="table table-striped" runat="server" AllowPaging="true" PageSize="7" GridLines="None">
                                    <Columns>
                                        <asp:BoundField DataField="sct_name" HeaderText="Sub County"
                                            SortExpression="sct_name"></asp:BoundField>
                                        <asp:BoundField DataField="Total" HeaderText="Total Number"
